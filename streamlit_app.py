...
# --- Funções de Leitura/Escrita do Google Sheets (AGORA USANDO STREAMLIT_GSHEETS) ---

# Crie um objeto de conexão
# A conexão 'gsheets' deve ser configurada no seu arquivo .streamlit/secrets.toml ou
# diretamente no Streamlit Cloud como um segredo.
# Exemplo de secrets.toml:
# [connections.gsheets]
# spreadsheet = "YOUR_GOOGLE_SHEET_ID"
# worksheet = "Planos" # Opcional, pode ser definido no código como você já faz

@st.cache_data(ttl=600) # Recarrega a cada 10 minutos
def load_data_from_gsheets():
    try:
        # Crie a conexão. Streamlit gerencia a autenticação.
        # Se você não definir 'worksheet' nos secrets, passamos aqui.
        conn = st.connection("gsheets", type=GSheetsConnection)
        
        # Lê os dados da planilha
        # Use o 'worksheet' do seu código para especificar a aba
